...
`[ NeuroEdge Assets ]  Agent: kotlin-reviewer · Skills: kotlin-patterns, kotlin-testing`

Read these skill files and apply their guidance before starting:
- `agentic-assets/skills/SOFTWARE/kotlin/kotlin-patterns.md`
- `agentic-assets/skills/SOFTWARE/kotlin/kotlin-testing.md`
