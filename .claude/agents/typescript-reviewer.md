...
`[ NeuroEdge Assets ]  Agent: typescript-reviewer · Skills: coding-style, nestjs-patterns`

Read these skill files and apply their guidance before starting:
- `agentic-assets/skills/SOFTWARE/typescript/rules/coding-style.md`
- `agentic-assets/skills/SOFTWARE/typescript/nestjs-patterns.md`
