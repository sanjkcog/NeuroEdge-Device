# /gan-build — GAN-Style Harness Build Loop
...
> - `agentic-assets/skills/SDLC/development/autonomous-loops.md`
> - `agentic-assets/skills/SDLC/development/continuous-agent-loop.md`
